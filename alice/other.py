...
cities = {
    'москва': ['1652229/9b94c3f69c122da73b74', '1030494/9b09e3371ba059961f4c'],
    'нью-йорк': ['937455/1b559ee9257e236eb810', '937455/1a7a8c3d4e2d3472116e'],
    'париж': ["1533899/9b446dd268a6155412aa", '213044/d776056b588260afae4f']
}
countries = {
    'москва': "россия",
    'нью-йорк': "сша",
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if not sessionStorage[user_id]['game_started']:
            ...
            if 'помощь' in req['request']['nlu']['tokens']:
                res["response"]["text"] = "Привет! Я могу поиграть с тобой в игру." \
                                          "В ней твоя цель - определить в какой стране расположен город на картинке. Отгадаешь город по фото?"
                res['response']['buttons'] = [
                    {
                        'title': 'Да',
                        'hide': True
                ...
                if len(sessionStorage[user_id]['guessed_cities']) == 3:
                    ...
                    sessionStorage[user_id]['attempt1'] = 1
...
def play_game(res, req):
    ...
    city_guessed = sessionStorage[user_id]['city_guessed']
    if attempt == 1:
        ...
        if not city_guessed and get_city(req) == city:
            # если да, то добавляем город к sessionStorage[user_id]['guessed_cities'] и
            # отправляем пользователя на второй круг. Обратите внимание на этот шаг на схеме.
            res['response']['text'] = 'Правильно! Теперь попробуй угадать страну'
            sessionStorage[user_id]['city_guessed'] = True
            return
        elif city_guessed and get_country(req) == country:
            ...
            if attempt == 3:
                ...
                res['response']['text'] = f'Вы пытались. Это {city.title()}. Он находится в {country}. Сыграем ещё?'
                res['response']['buttons'] = [
                    {
                        'title': 'Да',
                        'hide': True
